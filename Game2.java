...
public class Game2 {
    ...
    public boolean checkObstacle(Enemy E,int pos){
        Point pq = new Point();
        pq.copy(E.getLocation());
        if ((pos <= 4)&&(pos >0)) {
            switch (pos) {
                case 1:{
                    pq.addX();
...
//            System.out.println("1-Right\n2-Left\n3-Up\n4-Down");
            ...
            int inp = sc.nextInt();
            int nextLoc1 = E1.nextLoc();
            while (checkObstacle(E1,nextLoc1)){

            }
            if (!(checkObstacle(E1,nextLoc1))){
                maze[prevLoc1.getY()][prevLoc1.getX()]=".";
                E1.move(nextLoc1);
                maze[E1.getLocation().getY()][E1.getLocation().getX()] = "E";
                prevLoc1 = E1.getLocation();
            }
            int nextLoc2 = E1.nextLoc();
            if (!(checkObstacle(E2,nextLoc2))){
